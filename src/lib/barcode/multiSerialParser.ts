...
export interface MultiSerialResult {
  serials: string[];
  format: "csv" | "newline" | "semicolon" | "json-array" | "json-object" | "gs1-multi";
  /** Per JSON object: eventuali metadata estratti (es. qty dichiarata) */
  declaredQty?: number;
  /** GTIN se presente nei dati (formato 6 - GS1 multi) */
  gtin?: string;
  /** Lotto se presente */
  lot?: string;
}
...
// ─── Parser 3: separatori comuni (CSV, newline, semicolon) ─────────────────
