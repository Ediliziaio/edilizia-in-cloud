...
export const TRIGGER_CATALOG: TriggerDefinition[] = [
  ...
  {
    id: 'email_ricevuta',
    label: 'Email ricevuta da un contatto',
    description: 'Un contatto del CRM ha scritto o risposto per email (casella collegata o risposta a un\'email marketing)',
    icon: 'Mail',
    categoria: 'marketing',
    dbEvent: 'INSERT',
    outputVariables: [
      { id: 'from', label: 'Indirizzo di chi scrive', type: 'string' },
      { id: 'subject', label: 'Oggetto', type: 'string' },
      { id: 'message', label: 'Testo (senza l\'email citata)', type: 'string' },
      { id: 'casella', label: 'Casella che ha ricevuto', type: 'string' },
      { id: 'contatto.id', label: 'ID Contatto', type: 'uuid' },
      { id: 'contatto.first_name', label: 'Nome contatto', type: 'string' },
      { id: 'contatto.last_name', label: 'Cognome contatto', type: 'string' },
      { id: 'contatto.full_name', label: 'Nome completo', type: 'string', example: 'Mario Rossi' },
  ...
  {
    id: 'documento_hr_in_scadenza',
    label: 'Documento del personale in scadenza',
    description: 'Scatta quando un documento HR (DURC, visita medica, corso sicurezza…) sta per scadere — emesso dal controllo scadenze giornaliero',
    icon: 'FileWarning',
    categoria: 'hr',
    dbEvent: 'SCHEDULED',
    outputVariables: [
      { id: 'dipendente.nome', label: 'Dipendente', type: 'string', example: 'Mario Rossi' },
      { id: 'documento.categoria', label: 'Tipo documento', type: 'string', example: 'DURC' },
      { id: 'documento.titolo', label: 'Titolo documento', type: 'string' },
      { id: 'documento.scadenza', label: 'Data scadenza', type: 'string', example: '31/08/2026' },
      { id: 'documento.giorni_rimanenti', label: 'Giorni rimanenti', type: 'number' },
    ],
    configSchema: [
      { id: 'categoria_documento', label: 'Tipo documento', type: 'select', required: false, defaultValue: 'tutte', options: [
        { value: 'tutte', label: 'Tutti i documenti' },
        { value: 'durc', label: 'DURC' },
        { value: 'contratto', label: 'Contratto' },
        { value: 'visita_medica', label: 'Visita medica' },
        { value: 'corso_sicurezza', label: 'Corso sicurezza' },
        { value: 'idoneita', label: 'Idoneità' },
      ...
      ], helpText: 'La finestra di preavviso è quella impostata sul documento in Personale (alert giorni prima).' },
    ],
  },
  {
    id: 'ferie_richiesta',
  ...
  {
    id: 'candidato_creato',
    label: 'Nuovo candidato in selezione',
    description: 'Scatta quando entra un candidato nella banca dati (dal modulo del sito, a mano, da campagna)',
    icon: 'UserPlus',
    categoria: 'hr',
    ...
    outputVariables: [
      ...
      { id: 'candidato.cognome', label: 'Cognome', type: 'string' },
      { id: 'candidato.email', label: 'Email', type: 'string' },
      { id: 'candidato.telefono', label: 'Telefono', type: 'string' },
      { id: 'candidato.ruolo', label: 'Ruolo cercato', type: 'string' },
      { id: 'candidato.citta', label: 'Città', type: 'string' },
      { id: 'candidato.fonte', label: 'Fonte (sito/manuale/campagna…)', type: 'string' },
    ],
  },
  {
    id: 'candidato_fase_cambiata',
    label: 'Candidato spostato di fase',
    description: 'Il candidato passa a una nuova fase della pipeline di selezione (kanban o scheda)',
    ...
    outputVariables: [
      ...
      { id: 'candidato.cognome', label: 'Cognome', type: 'string' },
      { id: 'candidato.ruolo', label: 'Ruolo cercato', type: 'string' },
      { id: 'candidato.fase_nome', label: 'Nuova fase', type: 'string' },
      { id: 'candidato.fase_precedente', label: 'Fase precedente', type: 'string' },
    ],
  },
  {
    id: 'candidato_assunto',
    label: 'Candidato assunto',
    description: "L'esito della selezione diventa Assunto: parte l'onboarding",
    icon: 'CheckCircle2',
    categoria: 'hr',
    dbTable: 'hr_candidati',
    dbEvent: 'UPDATE',
    ...
    outputVariables: [
      ...
      { id: 'candidato.email', label: 'Email', type: 'string' },
      { id: 'candidato.telefono', label: 'Telefono', type: 'string' },
      { id: 'candidato.ruolo', label: 'Ruolo', type: 'string' },
    ],
  },
  {
    id: 'colloquio_fissato',
    label: 'Colloquio registrato/fissato',
    description: 'Viene registrato un colloquio per un candidato (anche futuro, già in calendario)',
    icon: 'CalendarClock',
    categoria: 'hr',
    ...
    outputVariables: [
      ...
      { id: 'candidato.cognome', label: 'Cognome candidato', type: 'string' },
      { id: 'colloquio.data_colloquio', label: 'Data colloquio', type: 'date' },
      { id: 'colloquio.ora_colloquio', label: 'Ora', type: 'string' },
      { id: 'colloquio.tipo', label: 'Tipo colloquio', type: 'string' },
    ],
  },
