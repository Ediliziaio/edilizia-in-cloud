...
export const MODULI_VENDITA: readonly ModuloVendutaConfig[] = [
  ...
  },
  {
    ...
    descrizione:
      "Preventivatore vendita serramenti su misura: BOM completo, detrazione fiscale 50%/36%, ROI 10 anni, cronoprogramma lavori, import da sopralluogo Infissi e preventivo PDF con allegato tecnico pronto per il cliente.",
    icon: PanelTop,
    ...
    benefici: [
      ...
      "Detrazione 50%/36% + cashflow 10 anni",
  ...
  },
  {
    ...
    descrizione:
      "Preventivatore impianti termoidraulici: caldaie a condensazione, pompe di calore, sistemi ibridi, radiatori, pannelli radianti e idrosanitario. Computo metrico dai listini aziendali, detrazioni fiscali (caldaie a gas escluse) e preventivo PDF brandizzato.",
    icon: Flame,
    ...
    benefici: [
      ...
      "Detrazioni 50%/36% (caldaie a gas escluse)",
      "Preventivo PDF brandizzato a più pagine",
    ],
    prezzoMensile: 149,
  },
  ...
  },
  {
    ...
    descrizione:
      "Modulo per la vendita di cappotto termico esterno: calcolo trasmittanze, scelta materiali, dimensionamento e abbinamento delle detrazioni fiscali.",
    icon: Layers,
