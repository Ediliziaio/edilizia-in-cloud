...
export const queryKeys = {
  ...
  admin: {
    ...
    companyFeatureOverrides: (companyId: string) => ["admin-company-feature-overrides", companyId] as const,
    companyFlagAuditLog: (companyId: string) => ["admin-company-flag-audit-log", companyId] as const,
