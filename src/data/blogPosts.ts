...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    content: [
      ...
      {
        type: "table",
        heading: "Le categorie SOA che ricorrono di piu' in edilizia",
        headers: ["Categoria", "Cosa copre", "Chi la chiede tipicamente"],
        rows: [
          ["OG1", "Edifici civili e industriali", "Imprese edili generaliste: e' la categoria piu' diffusa"],
      ...
      },
      {
        ...
        rows: [
          ...
          ["II", "fino a 516.000 €", ""],
          ["III", "fino a 1.033.000 €", "Da qui in su si e' esonerati dalla patente a crediti"],
      ...
      },
      {
        ...
        body: "E' il punto che quasi nessuno mette in relazione, e che invece cambia la convenienza economica dell'intera operazione.\n\nDal 1° ottobre 2024 le imprese che operano nei cantieri devono avere la patente a crediti. Ma l'esonero e' previsto per le imprese in possesso di attestazione SOA in classifica pari o superiore alla III. Tradotto: se la tua impresa sta in III classifica o sopra, la SOA non ti serve solo per partecipare alle gare — ti toglie anche dal sistema della patente e da tutta la gestione del punteggio che ne consegue.\n\nQuesto sposta il calcolo di convenienza. Un'impresa in II classifica che valuta se salire alla III sta guardando l'importo dei lavori a cui puo' accedere; dovrebbe guardare anche il secondo effetto, che vale a prescindere dal fatto che partecipi o meno a gare pubbliche. Il costo del salto va confrontato con due benefici, non con uno.\n\nDall'altro lato, un'impresa in I o II classifica non e' esonerata e deve gestire la patente come tutte le altre. Ne abbiamo scritto in dettaglio nella [guida alla patente a crediti](/blog/patente-a-crediti-edilizia-guida/), inclusa la regola sul tetto delle decurtazioni multiple che quasi nessuno cita.",
      },
      {
        type: "section",
        heading: "I Certificati di Esecuzione Lavori: il Documento su cui si Costruisce Tutto",
        body: "La SOA non certifica quello che dici di saper fare: certifica quello che puoi dimostrare di aver fatto. E lo strumento della dimostrazione sono i Certificati di Esecuzione Lavori, i CEL.\n\nOgni lavoro pubblico eseguito genera un certificato rilasciato dalla stazione appaltante, che attesta importo, categorie, periodo e quota eseguita dall'impresa. Sono quei documenti che l'organismo di attestazione usa per verificare i requisiti tecnici. Nei lavori privati il meccanismo e' diverso e la documentazione va costruita in altro modo, il che rende il percorso piu' laborioso per chi lavora solo con committenti privati.\n\nDa qui discendono due comportamenti che separano le imprese preparate dalle altre. Il primo: i CEL vanno richiesti alla fine di ogni lavoro, non anni dopo quando servono. Recuperare un certificato da una stazione appaltante per un cantiere chiuso nel frattempo, magari con il RUP cambiato, e' un'impresa che puo' richiedere mesi. Il secondo: vanno controllati appena arrivano. Un CEL con la categoria sbagliata o con una quota di esecuzione errata e' carta che non ti qualifica, e la contestazione e' molto piu' facile subito che tre anni dopo.\n\nDetto in modo diretto: la qualificazione SOA si costruisce cantiere per cantiere, mentre i cantieri sono aperti. Chi ci pensa quando decide di partecipare a una gara ha gia' perso il tempo che serviva.",
      },
      {
        type: "section",
        heading: "Non Hai la SOA e la Gara e' Adesso: l'Avvalimento",
        body: "Esiste una via, prevista dal Codice, per partecipare a una gara usando i requisiti di un'altra impresa: si chiama avvalimento.\n\nIl meccanismo e' che un'impresa ausiliaria mette a disposizione i propri requisiti attraverso un contratto, e si assume una responsabilita' solidale verso la stazione appaltante per le prestazioni oggetto dell'appalto. Non e' un prestito di carta: l'ausiliaria e' impegnata sul serio, e questo e' il motivo per cui va scelta con la stessa attenzione con cui si sceglie un socio.\n\nDue avvertenze che evitano i guai piu' comuni. La prima: l'avvalimento e' uno strumento per accedere a un'opportunita' specifica, non una strategia. Un'impresa che partecipa sistematicamente in avvalimento sta pagando qualcuno per dei requisiti che potrebbe costruirsi, e nel frattempo non se li sta costruendo. La seconda: il contratto di avvalimento e' un documento su cui le stazioni appaltanti guardano con attenzione, e deve indicare in modo determinato risorse e mezzi messi a disposizione. Un contratto generico e' uno dei motivi ricorrenti di esclusione.\n\nL'alternativa strutturale, quando l'obiettivo e' un lavoro piu' grande di quanto la tua classifica consenta, resta il raggruppamento temporaneo di imprese: si partecipa insieme, ciascuno con i propri requisiti e la propria quota di esecuzione.",
      },
      {
        type: "section",
        heading: "Cosa Succede se Salti la Verifica Triennale",
        body: "E' l'errore piu' costoso e piu' banale dell'intero percorso, e capita a imprese perfettamente in regola.\n\nLa SOA vale cinque anni, ma al terzo scatta la verifica di mantenimento dei requisiti. Se non la fai nei termini, l'attestazione decade — e la parola decade e' importante: non e' sospesa, non e' congelata. Significa che l'impresa si ritrova senza qualificazione da un giorno all'altro, con tutto quello che ne consegue sulle gare in corso e sui contratti in essere.\n\nLa parte che fa piu' male e' che non e' un problema di requisiti: quasi sempre l'impresa i requisiti li ha ancora tutti, ha solo perso una scadenza. E rimettersi in carreggiata dopo la decadenza non e' una pratica di aggiornamento, e' ripartire.\n\nLa gestione corretta e' banale ma va fatta: la verifica triennale si avvia con mesi di anticipo, non nella settimana della scadenza, perche' l'organismo ha bisogno di tempo per l'istruttoria e perche' i documenti da produrre — bilanci, organico, certificazioni, CEL — vanno raccolti. Vale lo stesso per il rinnovo quinquennale. Se in azienda queste due date non stanno in un calendario con un alert, prima o poi una delle due arriva di sorpresa: sono scadenze che tornano ogni tre e cinque anni, cioe' abbastanza di rado da dimenticarsele.",
      },
      {
        type: "section",
        heading: "Quando la SOA Non Conviene (e Va Detto)",
        body: "Una guida che spinge tutti verso la SOA e' una guida che vende, non che informa. Ci sono casi in cui il percorso non ha senso, ed e' meglio saperlo prima di spendere.\n\nNon conviene a chi lavora stabilmente con committenti privati e non ha nessuna intenzione di cambiare. La SOA e' costruita sui lavori pubblici, e un'impresa che fa ristrutturazioni residenziali per famiglie sta pagando una qualificazione che non usera'. L'unico argomento che regge, in quel caso, e' l'esonero dalla patente a crediti dalla III classifica in su — ma la III classifica non e' il punto di partenza, e arrivarci solo per quello e' un giro molto lungo.\n\nNon conviene a chi non ha i lavori da certificare. La qualificazione si costruisce sui CEL, quindi un'impresa senza uno storico documentabile di lavori pubblici parte da un problema di sostanza, non di pratica burocratica. Prima si costruisce lo storico — anche partecipando a lavori sotto i 150.000 €, che la SOA non la richiedono — e poi ci si qualifica.\n\nE non conviene quando l'azienda non e' pronta a mantenerla. La SOA non e' un titolo che si prende e si mette in cornice: comporta una verifica al terzo anno, un rinnovo al quinto e il mantenimento continuativo dei requisiti, organico compreso. Un'impresa che si qualifica in un anno buono e poi ridimensiona l'organico si trova con un'attestazione che non riesce a confermare, avendo pagato tutto il percorso.\n\nIl criterio onesto e' questo: la SOA e' un investimento sensato se hai gia' deciso che i lavori pubblici sono un canale, se hai lo storico per dimostrarlo e se la struttura regge nel tempo. Se manca uno dei tre, il momento non e' adesso.",
      },
      {
        type: "section",
        heading: "In Sintesi: le Sei Cose da Ricordare",
        body: "Primo: la SOA serve per i lavori pubblici sopra i 150.000 €, e senza sei escluso a prescindere da esperienza e reputazione. Secondo: la classifica determina l'importo massimo dei lavori a cui puoi accedere, e si sale costruendo requisiti, non chiedendoli. Terzo: dalla III classifica in su sei esonerato dalla patente a crediti — un beneficio che vale anche se non partecipi a gare, e che va messo nel conto quando valuti il salto di classifica. Quarto: la qualificazione si costruisce cantiere per cantiere attraverso i CEL, che vanno richiesti a fine lavori e controllati subito, non recuperati anni dopo. Quinto: l'avvalimento serve per un'opportunita' specifica, non come strategia, e il contratto deve indicare risorse e mezzi in modo determinato. Sesto: la verifica triennale saltata fa DECADERE l'attestazione anche se hai tutti i requisiti — e' una scadenza che torna troppo di rado per ricordarsela a memoria.",
      },
      {
        type: "quote",
