...
export const blogPostsTemplateGratis: BlogPost[] = [
  ...
  },
  {
    ...
    category: "Normativa",
    tags: ["contratto subappalto edile", "fac simile subappalto", "subappalto edilizia", "clausole contratto appalto", "modello contratto subappalto", "contratto subappalto tra imprese edili", "reverse charge subappalto", "responsabilità solidale appalti"],
    publishedAt: "2026-07-25",
    ...
    content: [
      ...
      {
        type: "table",
        heading: "Subappalto nei lavori privati e negli appalti pubblici: cosa cambia",
        headers: ["", "Lavoro privato", "Appalto pubblico"],
        rows: [
      ...
      {
        type: "table",
        heading: "I documenti prima dell'ingresso: chi li rilascia e quanto durano",
        headers: ["Documento", "Chi lo rilascia", "Quanto vale", "Se manca"],
        rows: [
