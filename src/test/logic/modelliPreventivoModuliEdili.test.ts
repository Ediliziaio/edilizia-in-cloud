...
import { FULL_RST_MODULES, FULL_PARETI_SOFFITTI_MODULES, FULL_PERGOLE_MODULES, createFullRstTemplate } from "@/lib/moduli-vendita/fullRstModules";
...
const MODULI: Record<ModuloConModelli, { dir: string; H: string; ids: readonly string[]; crea: (id: string) => object }> = {
  ...
  ristrutturazione: { dir: "ristrutturazione", H: "Ristrutturazione", ids: [...FULL_RST_MODULES, ...FULL_PARETI_SOFFITTI_MODULES, ...FULL_PERGOLE_MODULES], crea: (id) => createFullRstTemplate(base as RstTemplatePdf, id as typeof FULL_RST_MODULES[number]) },
};
