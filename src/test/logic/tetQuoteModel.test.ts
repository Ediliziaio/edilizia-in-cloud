...
describe("registro unico dei preventivatori", () => {
  it("non usa mai un editor PDF come destinazione operativa", () => {
    ...
    // preventivatori edili (lib/moduli/modelloPreventivo: 6+6+7+9+6+6+5, col
    // Conto Termico nel Termoidraulico) e i cinque del Fotovoltaico. Fuori solo
    // le Facciate, senza preventivatore.
