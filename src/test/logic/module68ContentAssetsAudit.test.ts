...
describe("70 clean factory templates: independent content and local asset inventory", () => {
  it("covers exactly the agreed 70 models across 11 areas, with no missing or extra registry entries", () => {
    expect(MODULE68_MODELS).toHaveLength(70); expect(Object.keys(MODULE68_EXPECTED)).toHaveLength(11);
