...
describe("109 clean factory templates: independent content and local asset inventory", () => {
  it("covers exactly the agreed 109 models across 14 areas, with no missing or extra registry entries", () => {
    expect(MODULE68_MODELS).toHaveLength(109); expect(Object.keys(MODULE68_EXPECTED)).toHaveLength(14);
