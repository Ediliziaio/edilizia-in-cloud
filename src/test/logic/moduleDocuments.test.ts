...
describe("documenti dei moduli per intervento", () => {
  ...
  it("copre 109 interventi di 14 aree, con 91 a perimetro esplicito (fuori tetti e serramenti)", () => {
    expect(DOCUMENT_MODULE_COUNT).toBe(109);
    expect(Object.keys(AREA_DESIGN)).toHaveLength(14);
    expect(Object.keys(INTERVENTION_LIMITS)).toHaveLength(91);
  });
  it.each(
