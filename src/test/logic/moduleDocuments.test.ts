...
describe("documenti dei moduli per intervento", () => {
  ...
  it("copre 105 interventi di 13 aree, con 87 a perimetro esplicito (fuori tetti e serramenti)", () => {
    expect(DOCUMENT_MODULE_COUNT).toBe(105);
    expect(Object.keys(AREA_DESIGN)).toHaveLength(13);
    expect(Object.keys(INTERVENTION_LIMITS)).toHaveLength(87);
  });
  it.each(
