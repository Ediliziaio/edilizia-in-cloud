...
describe("documenti dei moduli per intervento", () => {
  ...
  it("copre 100 interventi di 13 aree, con 84 a perimetro esplicito (fuori tetti e serramenti)", () => {
    expect(DOCUMENT_MODULE_COUNT).toBe(100);
    expect(Object.keys(AREA_DESIGN)).toHaveLength(13);
    expect(Object.keys(INTERVENTION_LIMITS)).toHaveLength(84);
  });
  it.each(
