...
describe("documenti dei moduli per intervento", () => {
  ...
  it("copre 94 interventi di 13 aree, con 78 a perimetro esplicito (fuori tetti e serramenti)", () => {
    expect(DOCUMENT_MODULE_COUNT).toBe(94);
    expect(Object.keys(AREA_DESIGN)).toHaveLength(13);
    expect(Object.keys(INTERVENTION_LIMITS)).toHaveLength(78);
  });
  it.each(
