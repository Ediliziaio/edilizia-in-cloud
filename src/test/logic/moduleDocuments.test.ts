...
describe("documenti dei moduli per intervento", () => {
  ...
  it("copre 97 interventi di 13 aree, con 81 a perimetro esplicito (fuori tetti e serramenti)", () => {
    expect(DOCUMENT_MODULE_COUNT).toBe(97);
    expect(Object.keys(AREA_DESIGN)).toHaveLength(13);
    expect(Object.keys(INTERVENTION_LIMITS)).toHaveLength(81);
  });
  it.each(
