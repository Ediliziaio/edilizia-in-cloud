 ...
 * in _redirects cade nella regola «/blog/:slug → /blog/:slug/» e torna un 301.
 */
...
/** Come Cloudflare Pages: /blog/index.html e /confronto/index.html fanno 301 per le regole :slug. */
async function assetCloudflare(richiesta: Request) {
  const { pathname } = new URL(richiesta.url);
  if (pathname === "/blog/index.html" || pathname === "/confronto/index.html") {
...
describe("pagina prerenderizzata ai motori di ricerca", () => {
  it.each(["/blog/", "/confronto/"])("%s: Googlebot riceve la pagina vera anche se index.html fa 301", async (percorso) => {
