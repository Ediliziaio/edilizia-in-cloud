...
export const INTERNAL_TRIGGER_CATEGORIES: {
...
}[] = [
  {
    ...
    items: [
      ...
      { id: "order_overdue", label: "Ordine in ritardo", icon: "AlertTriangle", category: "ordini", description: "Quando un ordine supera la data prevista", availableVariables: ORDER_VARIABLES, disabled: true, disabledReason: "Prossimamente", disabled: true, disabledReason: "Prossimamente" },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "task_overdue", label: "Attività scaduta", icon: "AlertTriangle", category: "task", description: "Quando un'attività supera, disabled: true, disabledReason: "Prossimamente" la scadenza", availableVariables: TASK_VARIABLES },
    ],
  },
  {
    key: "magazzino",
