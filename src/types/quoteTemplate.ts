...
export const DEFAULT_TEMPLATE: Omit<QuoteTemplate, 'id' | 'company_id' | 'created_at' | 'updated_at'> = {
  kind: 'offerta',
  description: 'Master del PDF con gerarchia chiara, blocchi riutilizzabili e condizioni leggibili.',
  thumbnail_url: null,
  ...
  name: 'Offerta base professionale',
  is_default: true,
  is_active: true,
  layout: 'classic',
  logo_url: null,
...
export function blankTemplateForKind(kind: QuoteTemplateKind): typeof DEFAULT_TEMPLATE {
  ...
  return {
    ...
    is_default: false,
    description: kind === 'offerta' ? DEFAULT_TEMPLATE.description : null,
  };
}
