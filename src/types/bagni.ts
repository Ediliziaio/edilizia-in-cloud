...
export interface BgnListinoCapitolo { id: string; company_id: string; nome: string; ordine: number; }
export interface BgnListinoVoce {
  id: string; company_id: string; capitolo_id: string | null; codice: string | null;
  descrizione: string; unita_misura: BgnUnitaMisura;
...
export interface BgnComputoVoce {
  id: string; progetto_id: string; company_id: string; capitolo_nome: string;
  descrizione: string; unita_misura: BgnUnitaMisura; quantita: number;
...
export interface BgnProgettoMedia { id: string; progetto_id: string; company_id: string; tipo: string; url: string; caption: string | null; ordine: number; }
...
// la stessa forma.
export interface BgnListItem { titolo: string; descrizione?: string | null; }
export interface BgnTestimonianza { autore: string; ruolo?: string | null; testo: string; }
export interface BgnCronoFase { fase: string; durata?: string | null; descrizione?: string | null; }
export interface BgnFaqItem { domanda: string; risposta: string; }

export interface BgnTemplatePdf {
  id: string;
  company_id: string;
  ...
  usp: BgnListItem[];
  testimonianze: BgnTestimonianza[];
