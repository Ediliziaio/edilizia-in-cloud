...
export type IdrUnitaMisura = "mq" | "ml" | "cad" | "corpo" | "kg" | "h" | "a corpo";
export type IdrStato = "bozza" | "da_consegnare" | "consegnato" | "in_valutazione" | "accettato" | "rifiutato" | "scaduto" | "archiviato";

export interface IdrListinoCapitolo { id: string; company_id: string; nome: string; ordine: number; }
export interface IdrListinoVoce {
  id: string; company_id: string; capitolo_id: string | null; codice: string | null;
  descrizione: string; unita_misura: IdrUnitaMisura;
...
export interface IdrComputoVoce {
  id: string; progetto_id: string; company_id: string; capitolo_nome: string;
  descrizione: string; unita_misura: IdrUnitaMisura; quantita: number;
...
// la stessa forma.
export interface IdrListItem { titolo: string; descrizione?: string | null; }
export interface IdrTestimonianza { autore: string; ruolo?: string | null; testo: string; }
export interface IdrCronoFase { fase: string; durata?: string | null; descrizione?: string | null; }
export interface IdrFaqItem { domanda: string; risposta: string; }

export interface IdrTemplatePdf {
  id: string;
  company_id: string;
  ...
  usp: IdrListItem[];
  testimonianze: IdrTestimonianza[];
