...
import { calcRigaImporto } from "@/lib/piscine/calcoli";
import type { PisComputoVoce, PisUnitaMisura } from "@/types/piscine";

/** Unità di misura selezionabili (allineate a `PisUnitaMisura`). */
const UM_OPTIONS: PisUnitaMisura[] = ["mq", "ml", "cad", "corpo", "kg", "h", "a corpo"];

interface Props {
  voce: PisComputoVoce;
  onChange: (patch: Partial<PisComputoVoce>) => void;
  onDelete: () => void;
  onDuplicate: () => void;
  showMargine: boolean;
}
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="flex items-center gap-2">
            ...
            <Select
              ...
              onValueChange={(v) => onChange({ unita_misura: v as PisUnitaMisura })}
            >
