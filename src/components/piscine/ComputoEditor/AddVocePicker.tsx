 ...
 *      - Lavorazioni → `pis_listino_voci`   (voce completa: mat + mano + prezzo)
 ...
 *      computo (NON passa da `pis_listino`).
 *
 ...
 * `PickedVoce` neutra: la materializzazione in `PisComputoVoce` la fa il padre.
 *
