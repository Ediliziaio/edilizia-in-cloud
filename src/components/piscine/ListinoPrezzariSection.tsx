 ...
 * Per questo vive in una pagina dedicata (PiscineListino) e non
 * dentro l'editor del template (che configura solo l'aspetto del preventivo).
 *
 *  1) ImportaPrezzarioDialog → adotta voci ufficiali in `pis_listino_voci`
...
const ListinoLavorazioniEditor = lazy(() =>
  import("@/components/piscine/ListinoLavorazioniEditor").then((m) => ({
