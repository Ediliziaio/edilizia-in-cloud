 ...
 *      - Lavorazioni → `tet_listino_voci`   (voce completa: mat + mano + prezzo)
 ...
 *      computo (NON passa da `tet_listino`).
 *
 ...
 * `PickedVoce` neutra: la materializzazione in `TetComputoVoce` la fa il padre.
 *
