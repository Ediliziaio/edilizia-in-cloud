 ...
 * Per questo vive in una pagina dedicata (TettiListino) e non
 * dentro l'editor del template (che configura solo l'aspetto del preventivo).
 *
 *  1) ImportaPrezzarioDialog → adotta voci ufficiali in `tet_listino_voci`
...
const ListinoLavorazioniEditor = lazy(() =>
  import("@/components/tetti/ListinoLavorazioniEditor").then((m) => ({
