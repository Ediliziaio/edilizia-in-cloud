    ...
    <Card>
      <CardHeader className="pb-2">
        <CardTitle className="flex items-center gap-2 text-base">
          <Headphones className="h-4 w-4" /> Chiamate dall'assistente
        </CardTitle>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="space-y-1">
          ...
          <p className="text-xs text-muted-foreground">È il telefono su cui squilla davvero. In formato internazionale.</p>
        </div>
        ...
        <div className="border-t pt-3">
          ...
          {colleghi.length === 0 ? (
            <p className="text-sm text-muted-foreground">
              Nessuno è disponibile. L'assistente non promette il passaggio: propone un appuntamento e lascia la scheda
              all'ufficio.
            </p>
          ) : (
