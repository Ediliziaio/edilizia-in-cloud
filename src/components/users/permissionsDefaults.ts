...
export const CANTIERI_SECTIONS: PermissionSectionDef[] = [
  ...
  { label: "Esporta Clienti",        viewKey: "can_export_clients",          editKey: null, description: "Scarica in CSV/Excel clienti, contatti e opportunità (anche l'archivio completo): ogni esportazione resta nel registro" },
