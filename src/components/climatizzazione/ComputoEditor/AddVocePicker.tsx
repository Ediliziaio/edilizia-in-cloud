 ...
 *      - Lavorazioni → `clm_listino_voci`   (voce completa: mat + mano + prezzo)
 ...
 *      computo (NON passa da `clm_listino`).
 *
 ...
 * `PickedVoce` neutra: la materializzazione in `ClmComputoVoce` la fa il padre.
 *
