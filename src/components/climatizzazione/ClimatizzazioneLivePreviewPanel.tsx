/**
 * ClimatizzazioneLivePreviewPanel — wrapper vertical del pannello anteprima live
 * condiviso (PdfBlobLivePreviewPanel). Porta i mock builder Climatizzazione +
 * renderClmPreviewBlobUrl, così l'anteprima è persistente a lato dell'editor.
 */
