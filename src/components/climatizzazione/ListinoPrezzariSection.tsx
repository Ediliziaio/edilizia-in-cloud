 ...
 * Per questo vive in una pagina dedicata (ClimatizzazioneListino) e non
 * dentro l'editor del template (che configura solo l'aspetto del preventivo).
 *
 *  1) ImportaPrezzarioDialog → adotta voci ufficiali in `clm_listino_voci`
...
const ListinoLavorazioniEditor = lazy(() =>
  import("@/components/climatizzazione/ListinoLavorazioniEditor").then((m) => ({
