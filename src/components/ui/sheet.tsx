...
// Mobile hardening sistemico:
//  • overflow-y-auto di default → contenuti lunghi sempre scrollabili (prima i pannelli
//    laterali senza scroll lasciavano i bottoni in fondo irraggiungibili, es. dettaglio
//    transazione Tesoreria su iPhone SE);
//  • left/right: w-full su mobile (il default 75% lasciava sheet da 281px a 375px),
//    invariato da sm in su (cap sm:max-w-sm già presente);
//  • bottom: max-h in dvh (con vh la barra di Safari iOS clippa la parte alta);
//  • apertura 300ms come la chiusura (500ms percepita lenta su mobile).
