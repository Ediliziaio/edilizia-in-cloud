...
export function ElettricoTemplateEditor({ embedded = false }: Props) {
  ...
  const ELE_SECTION_GROUPS: Array<{
    ...
    },
    {
      ...
      items: PAGINE_EDITOR_EDILI.map((p) => ({ id: p.id as EleSection, label: p.voce, emoji: p.emoji, descr: p.descrizione })),
    },
    {
          ...
          {activeSection === "page_ordine" && (
            <SectionCard icon={ListOrdered} title="Ordine e pagine" description="In che ordine escono i capitoli, quali nascondere, e le pagine scritte da voi.">
              <OrdineCapitoli
                ...
                apriSezione={(sezione) => setActiveSection(sezione as EleSection)}
