 ...
 * Per questo vive in una pagina dedicata (ElettricoListino) e non
 * dentro l'editor del template (che configura solo l'aspetto del preventivo).
 *
 *  1) ImportaPrezzarioDialog → adotta voci ufficiali in `ele_listino_voci`
...
const ListinoLavorazioniEditor = lazy(() =>
  import("@/components/elettrico/ListinoLavorazioniEditor").then((m) => ({
