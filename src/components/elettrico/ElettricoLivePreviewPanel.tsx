/**
 * ElettricoLivePreviewPanel — wrapper vertical del pannello anteprima live
 * condiviso (PdfBlobLivePreviewPanel). Porta i mock builder Elettrico +
 * renderElePreviewBlobUrl, così l'anteprima è persistente a lato dell'editor.
 */
