 ...
 *      - Lavorazioni → `ele_listino_voci`   (voce completa: mat + mano + prezzo)
 ...
 *      computo (NON passa da `ele_listino`).
 *
 ...
 * `PickedVoce` neutra: la materializzazione in `EleComputoVoce` la fa il padre.
 *
