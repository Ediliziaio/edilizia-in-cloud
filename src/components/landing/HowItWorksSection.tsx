      ...
      <div ref={ref} className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        >
          ...
          <h2 className="text-3xl md:text-5xl font-extrabold text-[#111111] mb-4">
            Tre passi per <span style={{ color: "#F97415" }}>controllare tutto</span>
          </h2>
        ...
        <div className="relative">
          ...
          <div
            ...
            style={{ backgroundColor: "rgba(249, 116, 21, 0.15)" }}
          />
          {/* Animated fill layer */}
          <div
              ...
              >
                ...
                <div
                  ...
                  style={{
                    ...
                    border: "2.5px solid #F97415",
                    boxShadow: isVisible
                      ? "0 4px 20px rgba(249, 116, 21, 0.25)"
                      : "none",
                ...
                >
                  ...
                  <step.icon size={26} color="#F97415" />
                </div>
                ...
                >
                  <h3 className="text-[#111111] font-bold text-xl mb-3">{step.title}</h3>
        ...
        >
          <a
            ...
            style={{
              backgroundColor: "#F97415",
              boxShadow: "0 8px 24px rgba(249, 116, 21, 0.3)",
            }}
          >
