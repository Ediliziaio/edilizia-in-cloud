 ...
 * Per questo vive in una pagina dedicata (TermoidraulicoListino) e non
 * dentro l'editor del template (che configura solo l'aspetto del preventivo).
 *
 *  1) ImportaPrezzarioDialog → adotta voci ufficiali in `idr_listino_voci`
...
const ListinoLavorazioniEditor = lazy(() =>
  import("@/components/termoidraulico/ListinoLavorazioniEditor").then((m) => ({
