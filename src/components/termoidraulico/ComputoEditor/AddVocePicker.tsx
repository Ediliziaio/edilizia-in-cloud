 ...
 *      - Lavorazioni → `idr_listino_voci`   (voce completa: mat + mano + prezzo)
 ...
 *      computo (NON passa da `idr_listino`).
 *
 ...
 * `PickedVoce` neutra: la materializzazione in `IdrComputoVoce` la fa il padre.
 *
