...
import { calcRigaImporto } from "@/lib/termoidraulico/calcoli";
import type { IdrComputoVoce, IdrUnitaMisura } from "@/types/termoidraulico";

/** Unità di misura selezionabili (allineate a `IdrUnitaMisura`). */
const UM_OPTIONS: IdrUnitaMisura[] = ["mq", "ml", "cad", "corpo", "kg", "h", "a corpo"];

interface Props {
  voce: IdrComputoVoce;
  onChange: (patch: Partial<IdrComputoVoce>) => void;
  onDelete: () => void;
  onDuplicate: () => void;
  showMargine: boolean;
}
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="flex items-center gap-2">
            ...
            <Select
              ...
              onValueChange={(v) => onChange({ unita_misura: v as IdrUnitaMisura })}
            >
