...
type FormState = Required<Pick<PavTemplatePdf,
...
export function PavimentiTemplateEditor({ embedded = false }: Props) {
  ...
  const handleSave = async () => {
    if (!form) return;
    const patch: PavTemplatePatch = { ...form };
    try {
                ...
                <div className="space-y-3">
                  <div className="space-y-1.5">
                    ...
                    <Input
                      ...
                      placeholder="Preventivo di pavimenti"
                    />
                  </div>
                  <div className="space-y-1.5">
        ...
        <DialogContent className="sm:max-w-md">
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              rows={3}
              placeholder="Es. Pavimenti chiavi in mano, 20 anni di esperienza, squadra interna, impianti idraulici ed elettrici certificati."
            />
            <p className="text-[11px] text-muted-foreground">
