/**
 * PavimentiLivePreviewPanel — wrapper vertical del pannello anteprima live
 * condiviso (PdfBlobLivePreviewPanel). Porta i mock builder Pavimenti +
 * renderPavPreviewBlobUrl, così l'anteprima è persistente a lato dell'editor.
 */
