...
/** Unità di misura selezionabili (allineate a `PavUnitaMisura`). */
const UM_OPTIONS: PavUnitaMisura[] = ["mq", "ml", "cad", "corpo", "kg", "h", "a corpo"];

interface Props {
  voce: PavComputoVoce;
  onChange: (patch: Partial<PavComputoVoce>) => void;
  onDelete: () => void;
  onDuplicate: () => void;
  showMargine: boolean;
}
