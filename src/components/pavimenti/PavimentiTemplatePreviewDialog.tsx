/**
 * PavimentiTemplatePreviewDialog — anteprima LIVE del PDF cliente in un
 ...
 * funziona anche col modulo Pavimenti non ancora pubblicato sul DB.
 *
...
function buildMockProgetto(companyId: string): PavProgetto {
  return {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="flex h-[88vh] max-w-5xl flex-col gap-0 p-0">
        ...
        <div className="relative min-h-0 flex-1 bg-muted/30">
          ...
          {url && (
            <iframe title="Anteprima PDF Pavimenti" src={url} className="h-full w-full border-0" />
          )}
        </div>
      </DialogContent>
    </Dialog>
