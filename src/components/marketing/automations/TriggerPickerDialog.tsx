...
import { Search, ChevronRight, ChevronDown, Zap, User, Target, CalendarDays, MessageSquare, Settings } from "lucide-react";
...
export function TriggerPickerDialog({ open, onOpenChange, onSelect }: Props) {
