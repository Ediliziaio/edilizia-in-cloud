 ...
 * Per questo vive in una pagina dedicata (BagniListino) e non
 * dentro l'editor del template (che configura solo l'aspetto del preventivo).
 *
 *  1) ImportaPrezzarioDialog → adotta voci ufficiali in `bgn_listino_voci`
...
const ListinoLavorazioniEditor = lazy(() =>
  import("@/components/bagni/ListinoLavorazioniEditor").then((m) => ({
