 ...
 *      - Lavorazioni → `bgn_listino_voci`   (voce completa: mat + mano + prezzo)
 ...
 *      computo (NON passa da `bgn_listino`).
 *
 ...
 * `PickedVoce` neutra: la materializzazione in `BgnComputoVoce` la fa il padre.
 *
