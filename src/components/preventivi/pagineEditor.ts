...
export const PAGINE_EDITOR_EDILI: PaginaEditor[] = [
  ...
  { id: "page_protezione", voce: "Protezione degli ambienti", emoji: "🏠", icona: Home, descrizione: "Come proteggete gli ambienti durante i lavori", pagina: "protezione", blocco: "protezione" },
...
export const PAGINE_EDITOR_SERRAMENTI: PaginaEditor[] = [
  { id: "page_ordine", voce: "Ordine e pagine", emoji: "🔀", descrizione: "In che ordine escono le pagine e quali nascondere", pagina: null, esistente: true },
  { id: "page_cover", voce: "Copertina", emoji: "🖼️", descrizione: "Prima pagina del preventivo", pagina: null, esistente: true },
  { id: "page_chi_siamo", voce: "Chi siamo", emoji: "👋", descrizione: "Presentazione azienda", pagina: "chi_siamo", esistente: true },
  { id: "page_come_funziona", voce: "Come funziona", emoji: "🔧", icona: Wrench, descrizione: "Vetro, telaio, posa: cosa rende isolante un serramento", pagina: "come_funziona", blocco: "comeFunziona" },
  { id: "page_render", voce: "Simulazione prima e dopo", emoji: "🪄", descrizione: "Prima/dopo + disclaimer", pagina: "render", esistente: true },
  { id: "page_percorso", voce: "Come lavoriamo", emoji: "🗺️", descrizione: "Fasi e step cliente", pagina: "percorso", foto: { chiave: "percorso", nota: "Esce sotto le fasi, se la pagina ha posto." }, esistente: true },
  { id: "page_protezione", voce: "Protezione degli ambienti", emoji: "🏠", icona: Home, descrizione: "Come proteggete la casa durante la posa", pagina: "protezione", blocco: "protezione" },
  { id: "page_controlli", voce: "Controlli di qualità", emoji: "✅", icona: ClipboardCheck, descrizione: "Cosa verificate prima della consegna", pagina: "controlli", blocco: "controlli" },
  { id: "page_documenti", voce: "Documenti consegnati", emoji: "📁", icona: FolderCheck, descrizione: "Il fascicolo che il cliente riceve a fine lavori", pagina: "documenti", blocco: "documenti" },
  ...
  { id: "page_garanzie", voce: "Le garanzie", emoji: "🛡️", icona: ShieldCheck, descrizione: "Le garanzie con il loro sigillo", pagina: "garanzie", testata: "garanzie" },
  ...
  { id: "page_faq", voce: "Domande e risposte", emoji: "❓", icona: HelpCircle, descrizione: "Le risposte prima della firma", pagina: "faq", testata: "domande" },
  { id: "page_cta", voce: "I prossimi passi", emoji: "✅", descrizione: "La pagina finale: i prossimi passi", pagina: "cta", foto: { chiave: "cta", nota: FASCIA }, esistente: true },
...
export const PAGINE_EDITOR_FOTOVOLTAICO: PaginaEditor[] = [
  ...
  { id: "page_percorso", voce: "Come lavoriamo", emoji: "🗺️", descrizione: "Iter cliente e pratiche.", pagina: "iter", esistente: true },
  { id: "page_come_funziona", voce: "Come funziona", emoji: "🔧", icona: Wrench, descrizione: "Produce, converte, conserva, scambia.", pagina: "come_funziona", blocco: "comeFunziona" },
  { id: "page_protezione", voce: "Protezione degli ambienti", emoji: "🏠", icona: Home, descrizione: "Come lavorate sul tetto e proteggete la casa.", pagina: "protezione", blocco: "protezione" },
  ...
  { id: "page_faq", voce: "Domande e risposte", emoji: "❓", icona: HelpCircle, descrizione: "Le risposte prima della firma.", pagina: "faq", testata: "domande", foto: { chiave: "faq", nota: FASCIA } },
  { id: "page_render", voce: "Simulazione prima e dopo", emoji: "🪄", descrizione: "Nota anteprima impianto.", pagina: null, esistente: true },
  { id: "page_cta", voce: "I prossimi passi", emoji: "✅", descrizione: "Titolo, testo e firma.", pagina: "decisione", foto: { chiave: "decisione", nota: FASCIA }, esistente: true },
