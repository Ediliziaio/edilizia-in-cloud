...
const config: FunzionalitaPageConfig = {
  ...
  seo: {
    ...
    description:
      "Gestisci ritenute di garanzia 0,5% Legge 296/2006 e 4% INPS subappalto art. 17 ter D.P.R. 633/72, con scadenze svincolo automatiche, controllo DURC e archivio a norma.",
    keywords:
