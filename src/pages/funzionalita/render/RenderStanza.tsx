...
const config: RenderPageConfig = {
  ...
  seo: {
    ...
    description:
      "Render Stanza AI: trasforma la foto di soggiorno, cucina, camera o ufficio del cliente in un prima/dopo realistico con nuovi mobili, illuminazione, tessuti e finiture.",
    keywords:
