...
const config: FunzionalitaPageConfig = {
  ...
  seo: {
    ...
    description:
      "Reportistica fatturazione per imprese edili: dashboard mensile fatturato, incassato e scaduto, report per cliente, cantiere, agente e periodo, con KPI commerciali pronti.",
    keywords:
