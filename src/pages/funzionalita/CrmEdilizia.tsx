...
const config: FunzionalitaPageConfig = {
  ...
  seo: {
    title:
      "CRM Edilizia — Pipeline Preventivi, Gestione Lead e Tag Cantieri | Edilizia in Cloud",
    description:
      "CRM verticale per imprese edili: pipeline preventivi visuale, lead da Google/Facebook/passaparola, tagging cantieri (residenziale/commerciale/industriale), follow-up automatici. +5% conversione media.",
    keywords:
