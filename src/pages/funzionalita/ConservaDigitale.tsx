...
const config: FunzionalitaPageConfig = {
  ...
  seo: {
    title:
      "Conservazione Digitale a Norma per Edilizia — CAD D.Lgs 82/2005 e Marca Temporale AgID | Edilizia in Cloud",
    description:
      "Conservazione decennale a norma CAD per fatture, contratti, DDT, libri contabili e SAL. Marca temporale qualificata AgID, responsabile della conservazione delegato, esibizione su richiesta GdF in 5 minuti. Conformità immediata.",
    keywords:
    ...
    ogImage: "https://www.ediliziaincloud.com/og/conserva-digitale-og.jpg",
  },
