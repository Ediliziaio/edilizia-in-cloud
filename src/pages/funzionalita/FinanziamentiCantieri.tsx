...
const config: FunzionalitaPageConfig = {
  ...
  seo: {
    ...
    description:
      "Gestisci cessione del credito Superbonus, Sismabonus ed Ecobonus, factoring fatture cantiere e anticipo SAL bancario, con dossier di finanziabilità pronti per la banca.",
    keywords:
