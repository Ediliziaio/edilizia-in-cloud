...
import { Plus, Users, Trash2, UserPlus, Pencil, GripVertical, BarChart3 } from "lucide-react";
import {
  DndContext,
  closestCenter,
  DragOverlay,
...
function DraggableMember({ member, team, onRemove, isOverlay }: {
  member: TeamMember;
  team: Team;
...
// --- KPI Mini Stats ---
function TeamKpiBar({ membersCount, color }: { membersCount: number; color: string }) {
  return (
