      ...
      <div className="space-y-4">
        ...
        <Card className="bg-slate-50 border-slate-200">
          <CardContent className="p-3 text-xs text-slate-600">
            💡 I template aziendali sono il punto di partenza dei nuovi preventivi. I modelli della libreria si salvano per l'azienda e li usano i preventivi creati da un intervento (per ora non Fotovoltaico, Facciate e quattro modelli Serramenti).
          </CardContent>
        </Card>
      </div>
    );
