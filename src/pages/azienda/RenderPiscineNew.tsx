          ...
          {isMobile && !photoPreview ? (
            <>
              <ZonaFotoMobile
                ...
                suggerimento="Giardino o terrazzo, con la zona della piscina libera"
                accento="sky"
              />
        ...
        <div className="space-y-4 max-md:space-y-3">
          ...
          {isMobile && (
            <div className="flex gap-2">
              ...
              <MandaRenderMobile resultUrl={resultUrls[0]} nomeFile="render-piscina" className="min-w-0 flex-1" />
            </div>
          )}
