 ...
 * via `form`/`onChange`: l'autosave del wizard li persiste su `ele_progetti`.
...
import { INCENTIVI_ELETTRICO, calcDetraibile, superaMassimale } from "@/lib/preventivi/incentivi";
