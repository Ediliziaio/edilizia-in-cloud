      ...
      <CardContent className="p-4 sm:p-5 space-y-4 max-sm:flex max-sm:flex-col max-sm:gap-3 max-sm:space-y-0 max-sm:p-3">
        ...
        <div className="grid grid-cols-12 gap-3">
          ...
          <div className="col-span-6 sm:col-span-3">
            ...
            <Input
              ...
              onChange={(e) => onChange("numero_terminali", toInt(e.target.value))}
              placeholder="8"
        ...
        <div>
          ...
          <Textarea
            ...
            placeholder={isMobile ? "Vincoli, accessi, orari…" : "Es. posizione caldaia/canna fumaria, scarico condensa, distanze di sicurezza, allaccio gas, condominio con orari cantiere…"}
