/**
 * TermoidraulicoListino — pagina dedicata al LISTINO lavorazioni dell'azienda
...
import { ListinoPrezzariSection } from "@/components/termoidraulico/ListinoPrezzariSection";

export default function TermoidraulicoListino() {
  const navigate = useNavigate();
  return (
    <div className="min-h-screen bg-slate-50">
      {/* HERO HEADER — coerente con TermoidraulicoIndex */}
      <div
