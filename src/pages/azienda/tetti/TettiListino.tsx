/**
 * TettiListino — pagina dedicata al LISTINO lavorazioni dell'azienda
...
import { ListinoPrezzariSection } from "@/components/tetti/ListinoPrezzariSection";

export default function TettiListino() {
  const navigate = useNavigate();
  return (
    <div className="min-h-screen bg-slate-50">
      {/* HERO HEADER — coerente con TettiIndex */}
      <div
