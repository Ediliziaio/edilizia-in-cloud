/**
 * ClimatizzazioneListino — pagina dedicata al LISTINO lavorazioni dell'azienda
...
import { ListinoPrezzariSection } from "@/components/climatizzazione/ListinoPrezzariSection";

export default function ClimatizzazioneListino() {
  const navigate = useNavigate();
  return (
    <div className="min-h-screen bg-slate-50">
      {/* HERO HEADER — coerente con ClimatizzazioneIndex */}
      <div
