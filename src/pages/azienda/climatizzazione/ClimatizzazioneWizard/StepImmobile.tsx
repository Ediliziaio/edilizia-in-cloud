    ...
    <Card>
      ...
      <CardContent className="p-4 sm:p-5 space-y-4 max-sm:flex max-sm:flex-col max-sm:gap-3 max-sm:space-y-0 max-sm:p-3">
        ...
        <div className="flex items-center gap-2 max-sm:hidden">
          <div className="h-8 w-8 rounded-md bg-sky-50 text-sky-600 flex items-center justify-center max-sm:hidden">
        ...
        <div>
          ...
          <Textarea
            ...
            placeholder={isMobile ? "Vincoli, accessi, orari…" : "Es. unità esterna su balcone condominiale, distanze dai confini, accesso difficoltoso, posizione quadro elettrico…"}
