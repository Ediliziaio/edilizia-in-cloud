...
const EmailMarketing = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-2xl border bg-gradient-to-br from-card via-card to-orange-50/50 p-5 shadow-sm dark:to-orange-950/20">
        <div className="flex items-start gap-3">
          <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl bg-gradient-to-br from-orange-500 to-amber-500 text-white shadow-sm shadow-orange-200 dark:shadow-orange-950">
            <Mail className="h-5 w-5" />
          </div>
          <div>
            <h1 className="text-2xl font-bold text-foreground">Email Marketing</h1>
            <p className="text-sm text-muted-foreground">Gestisci campagne, template e monitora le performance</p>
          </div>
        </div>
      </div>
      ...
      <Tabs value={activeTab} onValueChange={handleTabChange}>
        <TabsList className="h-auto gap-1 rounded-2xl border bg-card p-2 shadow-sm">
          <TabsTrigger value="campagne" className="gap-1.5 data-[state=active]:bg-orange-50 data-[state=active]:text-orange-700 dark:data-[state=active]:bg-orange-950/50 dark:data-[state=active]:text-orange-300">
            <Send className="h-4 w-4" />
            Campagne
          </TabsTrigger>
          <TabsTrigger value="modelli" className="gap-1.5 data-[state=active]:bg-orange-50 data-[state=active]:text-orange-700 dark:data-[state=active]:bg-orange-950/50 dark:data-[state=active]:text-orange-300">
            <FileText className="h-4 w-4" />
            Modelli
          </TabsTrigger>
          <TabsTrigger value="statistiche" className="gap-1.5 data-[state=active]:bg-orange-50 data-[state=active]:text-orange-700 dark:data-[state=active]:bg-orange-950/50 dark:data-[state=active]:text-orange-300">
