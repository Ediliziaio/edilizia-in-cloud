 ...
 * via `form`/`onChange`: l'autosave del wizard li persiste su `pav_progetti`.
...
import { INCENTIVI_PAVIMENTI, calcDetraibile, superaMassimale } from "@/lib/preventivi/incentivi";
            ...
            <CardContent className="space-y-3">
              ...
              <div className="space-y-3 max-sm:grid max-sm:grid-cols-2 max-sm:gap-2 max-sm:space-y-0">
                <PctField
                  ...
                  hint="In edilizia spesso 10% (pavimenti) o 4% (prima casa)."
                />
                <PctField
                  id="pav-detrazione"
              ...
              />
              {/* Preset incentivi pavimenti: 1-click → imposta detrazione + massimale di spesa */}
              <div>
                <p className="mb-1 text-[10px] text-muted-foreground max-sm:hidden">Incentivi rapidi (pavimenti):</p>
                <div className="flex flex-wrap gap-1.5">
                  {INCENTIVI_PAVIMENTI.map((inc) => {
                    const active =
