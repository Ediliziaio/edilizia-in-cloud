/**
 * PavimentiListino — pagina dedicata al LISTINO lavorazioni dell'azienda
...
import { ListinoPrezzariSection } from "@/components/pavimenti/ListinoPrezzariSection";

export default function PavimentiListino() {
  const navigate = useNavigate();
  return (
    <div className="min-h-screen bg-slate-50">
      {/* HERO HEADER — coerente con PavimentiIndex */}
      <div
