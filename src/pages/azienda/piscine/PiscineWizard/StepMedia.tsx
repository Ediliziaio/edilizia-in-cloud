 ...
 *   Il path resta `{company_id}/piscine/{progetto_id}/{uuid}.{ext}`: le
 *   policy guardano la prima cartella, l'azienda su cui si lavora. In
 *   `pis_progetti_media.url` va il riferimento "progetti-media/<path>",
 *   non un link: si firma quando serve (anteprima qui sotto, PDF in
 *   usePiscinePDF), quindi non scade. Vedi src/lib/storage/fileRiservati.ts.
 *
