 ...
 * via `form`/`onChange`: l'autosave del wizard li persiste su `pis_progetti`.
            ...
            <CardContent className="space-y-3">
              ...
              <div className="space-y-3 max-sm:grid max-sm:grid-cols-2 max-sm:gap-2 max-sm:space-y-0">
                <PctField
                  ...
                  hint="In edilizia spesso 10% (piscine) o 4% (prima casa)."
                />
                <PctField
                  id="pis-detrazione"
              ...
              <div>
                <p className="mb-1 text-[10px] text-muted-foreground max-sm:hidden">Incentivi rapidi (piscine):</p>
                <div className="flex flex-wrap gap-1.5">
                  {INCENTIVI_PISCINE.map((inc) => {
                    const active =
