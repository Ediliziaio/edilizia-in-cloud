/**
 * PiscineListino — pagina dedicata al LISTINO lavorazioni dell'azienda
...
import { ListinoPrezzariSection } from "@/components/piscine/ListinoPrezzariSection";

export default function PiscineListino() {
  const navigate = useNavigate();
  return (
    <div className="min-h-screen bg-slate-50">
      {/* HERO HEADER — coerente con PiscineIndex */}
      <div
