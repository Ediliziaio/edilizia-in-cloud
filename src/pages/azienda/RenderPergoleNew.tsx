        ...
        <div className="space-y-4">
          {photoPreview && (
            <div className="rounded-lg overflow-hidden max-h-56">
              <img src={photoPreview} alt="Foto pergola" className="w-full h-full object-cover" />
            </div>
          )}
          ...
          <Card>
            <CardContent className="py-4">
              ...
              {photoPreview ? (
                ...
                <img src={resultUrls[0]} alt="Render pergola" className="w-full object-cover rounded-lg" />
              )}
            </CardContent>
          </Card>
