...
const CATEGORY_MAP: Record<string, CategoryMeta> = {
  "gestione-cantieri": {
    ...
    title: "Gestione Cantieri Edili — Guide e Strategie Operative | Edilizia in Cloud",
  ...
  "finanza-edilizia": {
    category: "Finanza",
    title: "Finanza Impresa Edile — Margini, Liquidità e Costi | Edilizia in Cloud",
  ...
  "hr-personale": {
    ...
    title: "HR e Personale Edilizia — Presenze, Squadre e Buste Paga | Edilizia in Cloud",
  ...
  "marketing-edilizia": {
    category: "Marketing",
    title: "Marketing per Imprese Edili — CRM, WhatsApp e Lead Generation | Edilizia in Cloud",
  ...
  "commerciale-edilizia": {
    ...
    title: "Commerciale Edilizia — Preventivi, Offerte e CRM | Edilizia in Cloud",
  ...
  "digitalizzazione-edilizia": {
    ...
    title: "Digitalizzazione Impresa Edile — Software, AI e Processi | Edilizia in Cloud",
