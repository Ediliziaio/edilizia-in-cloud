...
const GLOSSARY: GlossaryTerm[] = [
  ...
  { term: "Cassa Edile", category: "HR", definition: "Ente bilaterale paritetico che gestisce le prestazioni assistenziali e previdenziali dei lavoratori edili iscritti: ferie, gratifica natalizia, anzianità professionale edile (APE), contributi ENPAIA. Ogni impresa edile è obbligata ad iscrivere i propri operai alla Cassa Edile territorialmente competente.", relatedTerms: ["CCNL Edilizia", "Busta Paga", "Cassa Integrazione Edilizia (CIE)"], relatedBlogSlugs: [{ slug: "cassa-edile-come-funziona", title: "Cassa Edile: Come Funziona, Contributi e Obblighi" }] },
