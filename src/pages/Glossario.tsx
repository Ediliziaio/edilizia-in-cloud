...
const GLOSSARY: GlossaryTerm[] = [
  // A
  { term: "Analisi dei Margini", category: "Finanza", definition: "Calcolo della differenza tra i ricavi ottenuti da una commessa edile e i costi sostenuti (manodopera, materiali, subappaltatori, attrezzature). Un gestionale edile aggiornato consente di monitorare il margine reale su ogni commessa in tempo reale, non solo a consuntivo.", relatedTerms: ["Margine di Commessa", "Costo del Lavoro", "SAL"] },
  { term: "Appalto", category: "Contrattualistica", definition: "Contratto con cui un soggetto (appaltatore) si obbliga, verso corrispettivo in denaro, a compiere un'opera o un servizio in favore del committente. In edilizia può essere pubblico (bando di gara) o privato, con capitolato tecnico che definisce le lavorazioni.", relatedTerms: ["Subappalto", "Capitolato", "SAL"] },
  ...
  { term: "Subappalto", category: "Contrattualistica", definition: "Affidamento da parte dell'appaltatore principale di una porzione delle lavorazioni a un'altra impresa specializzata (subappaltatore). Soggetto a limiti percentuali fissati dalla legge per gli appalti pubblici e a obblighi di comunicazione al committente.", relatedTerms: ["Contratto di Subappalto", "DURC", "Appalto"] },
  // T
  { term: "Timbratura Cantiere", category: "HR", definition: "Registrazione dell'orario di entrata e uscita degli operai in cantiere. Può avvenire con badge fisici, app mobile o sistemi geolocalizzati. Fondamentale per il calcolo delle ore lavorate da imputare alla commessa e per le buste paga.", relatedTerms: ["Costo del Lavoro", "CCNL Edilizia", "Giornale dei Lavori"] },
  // V
...
export default function Glossario() {
  useSEO({
    title: "Glossario Edilizia — 40 Termini Chiave per Imprese Edili | Edilizia in Cloud",
    description: "Dizionario completo dei termini tecnici dell'edilizia italiana: SAL, DURC, Computo Metrico, CCNL Edilizia, Cassa Edile, Margine di Commessa e molto altro. Guida pratica per imprenditori edili.",
