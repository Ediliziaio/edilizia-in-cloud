  ...
  const profileMutation = useMutation({
    mutationFn: async () => {
      ...
      const { error } = await supabase
        .from("profiles")
        .update({ first_name: formData.firstName.trim(), last_name: formData.lastName.trim() })
        .eq("id", profile!.id);
      ...
      <div className="grid gap-6 lg:grid-cols-2">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => { setFormData({ ...formData, firstName: e.target.value }); setProfileErrors((p) => ({ ...p, firstName: "" })); }}
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => { setFormData({ ...formData, lastName: e.target.value }); setProfileErrors((p) => ({ ...p, lastName: "" })); }}
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            {/* Current */}
            <div className="space-y-2">
              <Label htmlFor="currentPw">Password Attuale</Label>
