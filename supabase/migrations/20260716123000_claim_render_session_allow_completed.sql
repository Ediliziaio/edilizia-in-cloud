-- RENDER F4 — Refinement mirato: il claim deve poter riprendere in carico
-- una sessione COMPLETED (correzione image-to-image del risultato).
-- Si sostituisce la firma a 2 parametri con quella a 3 (drop esplicito:
-- due overload renderebbero ambigua la chiamata PostgREST con named args).
