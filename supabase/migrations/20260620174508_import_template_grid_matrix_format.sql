...
-- Aggiorna import_article_family_template per accettare griglia_default
-- anche in formato MATRICE COMPATTO:
--   { "xs":[larghezze], "ys":[altezze], "m":[[riga ys[0]], [riga ys[1]], ...] }
--   dove m[i][j] = prezzo per (xs[j], ys[i]); null = cella non quotata.
