-- ============================================================================
-- Sync notturno Open Banking (Enable Banking) — pg_cron (già applicata via MCP)
-- ============================================================================
-- Ogni giorno alle 05:30 UTC chiama l'edge function bank-eb-cron, che
-- sincronizza movimenti+saldi di tutte le connessioni 'linked' e segna
