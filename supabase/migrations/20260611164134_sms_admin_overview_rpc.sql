...
BEGIN
  ...
  tenants AS (
    ...
    FROM sms_telnyx_accounts a
    JOIN companies c            ON c.id = a.company_id
    LEFT JOIN sms_telnyx_numbers n  ON n.company_id = a.company_id AND n.stato = 'attivo'
    LEFT JOIN sms_wallet w          ON w.company_id = a.company_id
    LEFT JOIN camp                  ON camp.company_id = a.company_id
    LEFT JOIN trans                 ON trans.company_id = a.company_id
    LEFT JOIN trans_fatt tf         ON tf.company_id = a.company_id
