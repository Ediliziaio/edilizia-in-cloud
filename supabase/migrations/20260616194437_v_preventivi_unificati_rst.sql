...
COMMENT ON VIEW public.v_preventivi_unificati IS
  'Convergenza preventivi cross-modulo (classico/serramenti/fotovoltaico/ristrutturazione). security_invoker=true. Mirror server-side di UnifiedPreventiviList.';
