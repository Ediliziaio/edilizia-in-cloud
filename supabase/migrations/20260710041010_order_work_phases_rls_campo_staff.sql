...
-- Effetto: gli operai non vedevano né aggiornavano le fasi dal rapportino
-- (select vuota silenziosa), e gli staff non gestivano le fasi lato ufficio.
-- Parità con le convenzioni di order_items.
