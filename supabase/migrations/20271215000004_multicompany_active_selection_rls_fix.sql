...
--
-- Lato frontend: AuthContext.switchMultiCompany chiama set_active_company() prima
-- di ripulire la cache, e un effetto di sync riallinea il DB alla selezione
-- ripristinata da sessionStorage a ogni reload.
-- ============================================================================
