...
-- FIX: con headers NULL l'operatore jsonb ? restituiva NULL → v_is_pec NULL →
-- IF NOT NULL non faceva RETURN → email normali marcate is_pec per errore.
-- Normalizziamo headers a '{}' e coalesce sul guard.
