...
-- Regola scelta dall'utente: value = totale del preventivo
--   ACCETTATO più recente; se nessuno accettato, totale del
--   preventivo più recente (qualsiasi stato, con totale > 0).
-- Fonti: quotes (generico/serramenti web), rst_progetti
--   (ristrutturazione), fv_progetti (fotovoltaico),
--   sr_progetti (serramenti). Trigger su I/U/D -> ricalcolo.
-- Idempotente.
-- ============================================================
