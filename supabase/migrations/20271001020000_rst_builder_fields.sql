-- Builder Ristrutturazione "come Serramenti": anagrafica template + tipografia +
-- toggle footer (pagina Brand) e controlli copertina (posizione logo, colore testo,
-- overlay). Idempotente. Migrazione LOCALE: applicata in pubblicazione del modulo.
