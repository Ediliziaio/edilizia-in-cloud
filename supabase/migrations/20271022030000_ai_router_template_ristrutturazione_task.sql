-- template_ristrutturazione — task router AI per generare i testi del template
-- preventivo Ristrutturazione. Modello testo (clona da listino_extract =
-- google/gemini-2.5-flash). Idempotente.
