-- ═══════════════════════════════════════════════════════════════════════════
-- Template Infissi v2 — schema completo per rilievo cantieri
-- ---------------------------------------------------------------------------
-- Aggiunte:
--   - Tipologie complete (Finestra 1/2/3/4 Ante, Portafinestra 1/2/3 Ante, ecc)
--   - Telaio: scelta L oppure Z (con Z30/Z35/Z60/Z65 mm di profondità)
--   - Lati con Z (multiselect compatta: alto/basso/destro/sinistro)
--   - Persiane: solo battente o scorrevole
--   - Multiselect "Cosa rilevo" (tapparella/cassonetto/zanzariera/persiana)
--     che mostra dinamicamente le rispettive sezioni di rilievo (via show_if
--     a livello sezione + operator 'contains' sul multiselect)
--   - Sezione Tapparella: larghezza/altezza + accessori (rulli, guide,
--     calotte, motorino)
--   - Sezione Cassonetto: altezza, larghezza, profondità, cilindro
--   - Sezione Zanzariera: larghezza, altezza, larghezza telaio
--   - Sezione Persiana: larghezza, altezza, aletta 35/60, tipo battente/scorr
--   - Nessun riferimento bonus/CCE/ecobonus (richiesta utente)
-- ═══════════════════════════════════════════════════════════════════════════
...
SET schema = $sch$
{
  ...
  "header_schema": [
    ...
    },
    {
      ...
      "icon": "calendar",
      "fields": [
        {"key": "urgenza", "label": "Tempistica desiderata", "type": "select", "width": 12,
          "options": [
            {"value": "urgente", "label": "Urgente (entro 30 gg)"},
            {"value": "breve", "label": "Breve (1-2 mesi)"},
            {"value": "medio", "label": "Medio (2-4 mesi)"},
  ...
  "area_definition": {
    "label": "Stanza",
    "label_plural": "Stanze",
    "name_suggestions": ["Soggiorno", "Cucina", "Camera da letto", "Camera ospiti", "Bagno", "Studio", "Mansarda", "Sala", "Disimpegno"],
    "fields": [
      {"key": "mq", "label": "Metratura stanza", "type": "dimension", "unit": "mq", "width": 6},
      {"key": "esposizione", "label": "Esposizione", "type": "select", "width": 6,
        "options": [
          ...
          {"value": "interna", "label": "Cortile interno"}
        ]}
    ],
    "required_photos": [
      {"key": "panoramica", "label": "Panoramica stanza", "required": true}
    ]
  },
  "element_types": [
    {
      ...
      "description": "Finestre, portefinestre, portoncini. Multiselect Complementi attiva le sezioni opzionali.",
      "allow_quantity": true,
      "sections": [
        {
          "key": "identificazione",
          ...
          "fields": [
            ...
            {"key": "materiale_attuale", "label": "Materiale attuale", "type": "select", "width": 6,
              "options": [
                {"value": "legno", "label": "Legno"}, {"value": "pvc", "label": "PVC"},
                {"value": "alluminio", "label": "Alluminio"},
                {"value": "alluminio_legno", "label": "Alluminio-legno"},
                {"value": "ferro", "label": "Ferro"}, {"value": "non_presente", "label": "Non presente"}
              ]},
            {"key": "materiale_richiesto", "label": "Materiale nuovo richiesto", "type": "select", "width": 6,
              "options": [
                {"value": "pvc", "label": "PVC"}, {"value": "alluminio", "label": "Alluminio"},
                {"value": "alluminio_legno", "label": "Alluminio-legno"}, {"value": "legno", "label": "Legno"}
              ]}
          ]
        },
        {
        ...
        {
          "key": "specifiche_nuovo",
          "label": "Specifiche nuovo infisso",
          "fields": [
            {"key": "apertura", "label": "Apertura", "type": "select", "width": 6,
              "options": [
            ...
            {"key": "colore_interno", "label": "Colore interno", "type": "text", "width": 6, "placeholder": "Es. RAL 9010 bianco"},
            {"key": "colore_esterno", "label": "Colore esterno", "type": "text", "width": 6, "placeholder": "Es. RAL 7016 grigio"},
    ...
    },
    {
      ...
      "icon": "Layers",
      "description": "Quando rilevi SOLO tapparelle (senza sostituzione infisso). Per tapparella associata a un infisso, usa il complemento dentro l'elemento Infisso.",
      "allow_quantity": true,
      "sections": [
        {
          "key": "specifiche",
...
$sch$::jsonb,
version = 2,
description = 'Sopralluogo completo per fornitura e posa di finestre, porte, persiane, tapparelle, zanzariere, cassonetti. Tipologie complete (1/2/3/4 ante), telaio L o Z (30/35/60/65 mm), complementi conditional per infisso o standalone.'
