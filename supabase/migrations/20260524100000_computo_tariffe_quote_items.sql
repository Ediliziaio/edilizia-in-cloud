-- Propaga il match tariffe/manodopera dal computo metrico alle righe preventivo.
-- Prima tutte le voci generate da computo uscivano come item_type='product' e
-- item_category='prodotto', anche quando erano posa, manodopera o servizi.
...
COMMENT ON FUNCTION public.silvio_tool_apply_computo_review IS
  'Crea quote+items da computo metrico in una singola transazione. Propaga prodotti, famiglie e tariffe/manodopera su quote_items.';
