...
-- Pinna search_path sulle funzioni public NOSTRE prive di SET search_path.
-- Chiude il vettore di privilege-escalation (hijack via session search_path) sui
-- SECURITY DEFINER, behavior-preserving: public + extensions + pg_temp (in coda).
