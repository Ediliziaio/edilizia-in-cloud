-- Enrichment geografico: passa al dataset comuni COMPLETO (it_comuni, 8456 comuni).
-- Regola anti-ambiguità: assegna provincia SOLO se CAP/città risolve a UNA provincia
-- (omonimi → skip). NON sovrascrive mai dati esistenti. Applicata in prod via MCP
-- il 2026-06-30. Backfill: città non risolte 87→13 (residue = dati sporchi/esteri),
-- regione 96→170 su 194.
