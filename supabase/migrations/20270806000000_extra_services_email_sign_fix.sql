...
-- (refund = storno). Il ricavo email del tab "Servizi Extra" risultava
-- sempre 0. Ora: revenue = sum(deduct) - sum(refund).
--
-- (Solo la CTE `em` cambia rispetto a 20270802000000.)
