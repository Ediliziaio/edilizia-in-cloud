...
--
-- Pattern allineato a create_order_atomic, storna_incasso_atomico,
-- adjust_credits_atomic già presenti in questo schema.
-- =============================================================================
...
REVOKE ALL ON FUNCTION public.save_quote_items_atomic(uuid, uuid, jsonb) FROM public;
