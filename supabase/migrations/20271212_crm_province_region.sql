-- Mappa CRM · analytics per regione: la regione dei record è quasi sempre vuota,
-- mentre la provincia (sigla) è popolata. Aggiungiamo la regione a
-- crm_province_centroids (sigla → regione) così le RPC possono derivarla dalla
-- provincia quando il campo region è NULL.
...
-- RPC region-stats: regione = region esplicita, altrimenti derivata da provincia.
