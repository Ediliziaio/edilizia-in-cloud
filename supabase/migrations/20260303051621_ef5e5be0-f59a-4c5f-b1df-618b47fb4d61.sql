...
BEGIN
  ...
  -- Previous pipeline value (for trend)
  ...
  -- ENTERPRISE: Avg time to close (days)
  ...
  -- ENTERPRISE: Forecast 30d = close_rate * avg_ticket * open opps in advanced stages (top 50% stages)
  ...
  -- SALES PERFORMANCE (with show_rate)
  WITH sales_users AS (
  ...
  -- ALERTS (enhanced with 3 severity levels)
