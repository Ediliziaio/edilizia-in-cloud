-- ============================================================================
-- Fix RPC Tesoreria per lo schema Enable Banking (già applicata via MCP)
-- ============================================================================
-- Le RPC erano scritte per il vecchio schema GoCardless:
--  - get_cash_flow_forecast: `i.type` inesistente (crash tab Previsioni) +
--    colonne scadenze sbagliate (importo/descrizione/data_scadenza/stato).
--  - filtro bc.status='active' mentre Enable Banking usa 'linked' → saldi/
--    conteggi sempre 0.
-- ============================================================================
