 ...
 * Sta qui perché la usano sia i PDF del browser sia il Fotovoltaico (edge function).
 *
...
/**
 * Sotto questa proporzione una foto sola è una «tavola»: una grafica verticale con le
 * scritte dentro (le tavole del pacchetto bento, 22/09/2026), o una foto verticale.
 * Non si ritaglia: si mostra intera, grande, con le voci del blocco accanto.
 */
export const PROPORZIONE_TAVOLA = 0.9;

/**
 * Le tavole di serie (public/pdf-stock/<settore>/tavola-*.jpg) sono tutte 4:5: si
 * riconoscono anche dall'indirizzo, quando la foto non è stata convertita (anteprime
