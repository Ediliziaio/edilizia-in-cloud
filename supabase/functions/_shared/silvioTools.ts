...
export const SILVIO_TOOLS: Record<string, SilvioTool> = {
  ...
  genera_creativita: {
    ...
    resultContract: "Hai accodato la generazione. Rispondi SOLO con UNA frase breve e umana (es. \"Sto creando l'immagine, sarà pronta tra pochi secondi 👇\"), SENZA tecnicismi: vietato scrivere 'job', 'Job ID', 'controlla il job', 'in elaborazione', 'eta_seconds', stato. Poi emetti SUBITO, su righe a parte, un blocco fenced con linguaggio 'silvio-image' che contiene esattamente {\"job_id\":\"<il job_id ricevuto>\"}. L'immagine apparirà e si rivelerà da sola nella chat. Dopo puoi offrire in una riga di preparare una campagna sponsorizzata.",
  },
