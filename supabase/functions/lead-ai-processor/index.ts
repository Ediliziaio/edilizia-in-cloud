...
Deno.serve(async (req) => {
  ...
  // La chiama solo whatsapp-webhook (handlers/lead.ts), con la chiave di
  ...
  // 2026-05-27 (AI cost audit): default → gpt-4o-mini. Lead enrichment +
  // qualification (status update, score) non richiede 4o full. Override
  // esplicito per tenant premium.
